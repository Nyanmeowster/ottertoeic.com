...
const WORDS: Word[] = [
  ...
  { word: "applicant", meaning: "申請人", pos: "n.", example: "The team reviewed the applicant before making a final decision.", exampleZh: "團隊在作出最終決定前檢視了申請人。", level: "基礎" },
  { word: "confirm", meaning: "確認", pos: "v.", example: "The manager will confirm the request before Friday's deadline.", exampleZh: "經理會在星期五截止前確認這項申請。", level: "基礎" },
  ...
  { word: "equipment", meaning: "設備", pos: "n.", example: "The staff inspected the equipment before it was sent to the customer.", exampleZh: "工作人員在送交顧客前檢查了設備。", level: "基礎" },
  ...
  { word: "purchase", meaning: "購買", pos: "v./n.", example: "The training manual explains when employees should purchase.", exampleZh: "訓練手冊說明員工應在何時購買。", level: "基礎" },
  ...
  { word: "accommodate", meaning: "容納；提供住宿", pos: "v.", example: "The manager will accommodate the request before Friday's deadline.", exampleZh: "經理會在星期五截止前容納這項申請。", level: "中階" },
  { word: "authorize", meaning: "授權；批准", pos: "v.", example: "The manager will authorize the request before Friday's deadline.", exampleZh: "經理會在星期五截止前授權這項申請。", level: "中階" },
  { word: "complimentary", meaning: "免費贈送的", pos: "adj.", example: "The committee described the revised proposal as complimentary.", exampleZh: "委員會認為修改後的提案是免費贈送的。", level: "中階" },
  ...
  { word: "eligible", meaning: "符合資格的", pos: "adj.", example: "The committee described the revised proposal as eligible.", exampleZh: "委員會認為修改後的提案是符合資格的。", level: "中階" },
  { word: "fluctuate", meaning: "波動", pos: "v.", example: "Sales may fluctuate after the company changes its pricing policy.", exampleZh: "公司調整定價政策後，銷售表現可能會波動。", level: "中階" },
  { word: "inventory", meaning: "庫存", pos: "n.", example: "The staff inspected the inventory before it was sent to the customer.", exampleZh: "工作人員在送交顧客前檢查了庫存。", level: "中階" },
  { word: "negotiate", meaning: "協商", pos: "v.", example: "The training manual explains when employees should negotiate.", exampleZh: "訓練手冊說明員工應在何時協商。", level: "中階" },
  { word: "reimburse", meaning: "償還；報銷", pos: "v.", example: "The training manual explains when employees should reimburse.", exampleZh: "訓練手冊說明員工應在何時償還。", level: "中階" },
  { word: "tentative", meaning: "暫定的", pos: "adj.", example: "The committee described the revised proposal as tentative.", exampleZh: "委員會認為修改後的提案是暫定的。", level: "中階" },
  { word: "alleviate", meaning: "減輕；緩和", pos: "v.", example: "The training manual explains when employees should alleviate.", exampleZh: "訓練手冊說明員工應在何時減輕。", level: "進階" },
  ...
  { word: "deteriorate", meaning: "惡化", pos: "v.", example: "Sales may deteriorate after the company changes its pricing policy.", exampleZh: "公司調整定價政策後，銷售表現可能會惡化。", level: "進階" },
  ...
  { word: "expedite", meaning: "加速；促進", pos: "v.", example: "The training manual explains when employees should expedite.", exampleZh: "訓練手冊說明員工應在何時加速。", level: "進階" },
  { word: "feasible", meaning: "可行的", pos: "adj.", example: "The committee described the revised proposal as feasible.", exampleZh: "委員會認為修改後的提案是可行的。", level: "進階" },
  ...
  { word: "lucrative", meaning: "獲利豐厚的", pos: "adj.", example: "The finance team found the revised estimate lucrative.", exampleZh: "財務團隊認為修改後的估算是獲利豐厚的。", level: "進階" },
  ...
  { word: "streamline", meaning: "精簡；使更有效率", pos: "v.", example: "The training manual explains when employees should streamline.", exampleZh: "訓練手冊說明員工應在何時精簡。", level: "進階" },
  ...
  { word: "branch", meaning: "分公司；分店", pos: "n.", example: "The company renovated the branch before the busy season began.", exampleZh: "公司在旺季開始前整修了分公司。", level: "基礎" },
  ...
  { word: "cancel", meaning: "取消", pos: "v.", example: "The manager will cancel the request before Friday's deadline.", exampleZh: "經理會在星期五截止前取消這項申請。", level: "基礎" },
  { word: "candidate", meaning: "候選人", pos: "n.", example: "The manager mentioned the candidate in the revised business report.", exampleZh: "經理在修改後的商務報告中提到了候選人。", level: "基礎" },
  ...
  { word: "deliver", meaning: "運送；交付", pos: "v.", example: "The training manual explains when employees should deliver.", exampleZh: "訓練手冊說明員工應在何時運送。", level: "基礎" },
  ...
  { word: "facility", meaning: "設施；場所", pos: "n.", example: "The company renovated the facility before the busy season began.", exampleZh: "公司在旺季開始前整修了設施。", level: "基礎" },
  ...
  { word: "product", meaning: "產品", pos: "n.", example: "The staff inspected the product before it was sent to the customer.", exampleZh: "工作人員在送交顧客前檢查了產品。", level: "基礎" },
  ...
  { word: "reserve", meaning: "預訂；保留", pos: "v.", example: "The training manual explains when employees should reserve.", exampleZh: "訓練手冊說明員工應在何時預訂。", level: "基礎" },
  ...
  { word: "shipment", meaning: "貨物；出貨", pos: "n.", example: "The staff inspected the shipment before it was sent to the customer.", exampleZh: "工作人員在送交顧客前檢查了貨物。", level: "基礎" },
  ...
  { word: "travel", meaning: "旅行；出差", pos: "n./v.", example: "The travel coordinator confirmed the travel before the business trip.", exampleZh: "差旅專員在出差前確認了旅行。", level: "基礎" },
  ...
  { word: "warehouse", meaning: "倉庫", pos: "n.", example: "The company renovated the warehouse before the busy season began.", exampleZh: "公司在旺季開始前整修了倉庫。", level: "基礎" },
  { word: "allocate", meaning: "分配", pos: "v.", example: "The training manual explains when employees should allocate.", exampleZh: "訓練手冊說明員工應在何時分配。", level: "中階" },
  { word: "anticipate", meaning: "預期", pos: "v.", example: "The training manual explains when employees should anticipate.", exampleZh: "訓練手冊說明員工應在何時預期。", level: "中階" },
  ...
  { word: "assess", meaning: "評估", pos: "v.", example: "The manager will assess the request before Friday's deadline.", exampleZh: "經理會在星期五截止前評估這項申請。", level: "中階" },
  ...
  { word: "collaborate", meaning: "合作", pos: "v.", example: "The training manual explains when employees should collaborate.", exampleZh: "訓練手冊說明員工應在何時合作。", level: "中階" },
  { word: "commence", meaning: "開始", pos: "v.", example: "The training manual explains when employees should commence.", exampleZh: "訓練手冊說明員工應在何時開始。", level: "中階" },
  ...
  { word: "consecutive", meaning: "連續的", pos: "adj.", example: "The manager confirmed that the new schedule was consecutive.", exampleZh: "經理確認新的時程是連續的。", level: "中階" },
  ...
  { word: "convenient", meaning: "方便的", pos: "adj.", example: "The committee described the revised proposal as convenient.", exampleZh: "委員會認為修改後的提案是方便的。", level: "中階" },
  { word: "coordinate", meaning: "協調", pos: "v.", example: "The training manual explains when employees should coordinate.", exampleZh: "訓練手冊說明員工應在何時協調。", level: "中階" },
  { word: "deduct", meaning: "扣除", pos: "v.", example: "The training manual explains when employees should deduct.", exampleZh: "訓練手冊說明員工應在何時扣除。", level: "中階" },
  { word: "defective", meaning: "有缺陷的", pos: "adj.", example: "The committee described the revised proposal as defective.", exampleZh: "委員會認為修改後的提案是有缺陷的。", level: "中階" },
  { word: "designate", meaning: "指定", pos: "v.", example: "The training manual explains when employees should designate.", exampleZh: "訓練手冊說明員工應在何時指定。", level: "中階" },
  { word: "distribute", meaning: "分發；配送", pos: "v.", example: "The training manual explains when employees should distribute.", exampleZh: "訓練手冊說明員工應在何時分發。", level: "中階" },
  { word: "efficient", meaning: "有效率的", pos: "adj.", example: "The committee described the revised proposal as efficient.", exampleZh: "委員會認為修改後的提案是有效率的。", level: "中階" },
  ...
  { word: "evaluate", meaning: "評價；評估", pos: "v.", example: "The manager will evaluate the request before Friday's deadline.", exampleZh: "經理會在星期五截止前評價這項申請。", level: "中階" },
  { word: "exceed", meaning: "超過", pos: "v.", example: "The training manual explains when employees should exceed.", exampleZh: "訓練手冊說明員工應在何時超過。", level: "中階" },
  { word: "implement", meaning: "實施", pos: "v.", example: "The training manual explains when employees should implement.", exampleZh: "訓練手冊說明員工應在何時實施。", level: "中階" },
  ...
  { word: "mandatory", meaning: "強制的；必要的", pos: "adj.", example: "The committee described the revised proposal as mandatory.", exampleZh: "委員會認為修改後的提案是強制的。", level: "中階" },
  { word: "modify", meaning: "修改", pos: "v.", example: "The manager will modify the request before Friday's deadline.", exampleZh: "經理會在星期五截止前修改這項申請。", level: "中階" },
  { word: "notify", meaning: "通知", pos: "v.", example: "The training manual explains when employees should notify.", exampleZh: "訓練手冊說明員工應在何時通知。", level: "中階" },
  { word: "postpone", meaning: "延期", pos: "v.", example: "The training manual explains when employees should postpone.", exampleZh: "訓練手冊說明員工應在何時延期。", level: "中階" },
  { word: "prohibit", meaning: "禁止", pos: "v.", example: "The training manual explains when employees should prohibit.", exampleZh: "訓練手冊說明員工應在何時禁止。", level: "中階" },
  { word: "prospective", meaning: "潛在的；預期的", pos: "adj.", example: "The committee described the revised proposal as prospective.", exampleZh: "委員會認為修改後的提案是潛在的。", level: "中階" },
  { word: "retain", meaning: "保留；留住", pos: "v.", example: "The training manual explains when employees should retain.", exampleZh: "訓練手冊說明員工應在何時保留。", level: "中階" },
  { word: "adjacent", meaning: "相鄰的", pos: "adj.", example: "The committee described the revised proposal as adjacent.", exampleZh: "委員會認為修改後的提案是相鄰的。", level: "進階" },
  { word: "advocate", meaning: "提倡；支持", pos: "v.", example: "The training manual explains when employees should advocate.", exampleZh: "訓練手冊說明員工應在何時提倡。", level: "進階" },
  { word: "amend", meaning: "修訂", pos: "v.", example: "The training manual explains when employees should amend.", exampleZh: "訓練手冊說明員工應在何時修訂。", level: "進階" },
  ...
  { word: "consolidate", meaning: "合併；鞏固", pos: "v.", example: "The training manual explains when employees should consolidate.", exampleZh: "訓練手冊說明員工應在何時合併。", level: "進階" },
  { word: "diligent", meaning: "勤勉的", pos: "adj.", example: "The committee described the revised proposal as diligent.", exampleZh: "委員會認為修改後的提案是勤勉的。", level: "進階" },
  { word: "diversify", meaning: "多元化", pos: "v.", example: "The training manual explains when employees should diversify.", exampleZh: "訓練手冊說明員工應在何時多元化。", level: "進階" },
  { word: "endorse", meaning: "認可；支持", pos: "v.", example: "The training manual explains when employees should endorse.", exampleZh: "訓練手冊說明員工應在何時認可。", level: "進階" },
  { word: "entail", meaning: "牽涉；需要", pos: "v.", example: "The training manual explains when employees should entail.", exampleZh: "訓練手冊說明員工應在何時牽涉。", level: "進階" },
  { word: "exemplary", meaning: "典範的；優秀的", pos: "adj.", example: "The committee described the revised proposal as exemplary.", exampleZh: "委員會認為修改後的提案是典範的。", level: "進階" },
  { word: "fiscal", meaning: "財政的；會計年度的", pos: "adj.", example: "The committee described the revised proposal as fiscal.", exampleZh: "委員會認為修改後的提案是財政的。", level: "進階" },
  { word: "impending", meaning: "即將發生的", pos: "adj.", example: "The manager confirmed that the new schedule was impending.", exampleZh: "經理確認新的時程是即將發生的。", level: "進階" },
  ...
  { word: "incompatible", meaning: "不相容的", pos: "adj.", example: "The committee described the revised proposal as incompatible.", exampleZh: "委員會認為修改後的提案是不相容的。", level: "進階" },
  { word: "indispensable", meaning: "不可或缺的", pos: "adj.", example: "The committee described the revised proposal as indispensable.", exampleZh: "委員會認為修改後的提案是不可或缺的。", level: "進階" },
  { word: "meticulous", meaning: "一絲不苟的", pos: "adj.", example: "The committee described the revised proposal as meticulous.", exampleZh: "委員會認為修改後的提案是一絲不苟的。", level: "進階" },
  { word: "obsolete", meaning: "過時的；淘汰的", pos: "adj.", example: "The committee described the revised proposal as obsolete.", exampleZh: "委員會認為修改後的提案是過時的。", level: "進階" },
  { word: "paramount", meaning: "最重要的", pos: "adj.", example: "The committee described the revised proposal as paramount.", exampleZh: "委員會認為修改後的提案是最重要的。", level: "進階" },
  { word: "plausible", meaning: "合理可信的", pos: "adj.", example: "The committee described the revised proposal as plausible.", exampleZh: "委員會認為修改後的提案是合理可信的。", level: "進階" },
  { word: "proficient", meaning: "熟練的", pos: "adj.", example: "The committee described the revised proposal as proficient.", exampleZh: "委員會認為修改後的提案是熟練的。", level: "進階" },
  { word: "prolonged", meaning: "長期的；延長的", pos: "adj.", example: "The committee described the revised proposal as prolonged.", exampleZh: "委員會認為修改後的提案是長期的。", level: "進階" },
  { word: "reconcile", meaning: "調和；核對", pos: "v.", example: "The training manual explains when employees should reconcile.", exampleZh: "訓練手冊說明員工應在何時調和。", level: "進階" },
  { word: "refrain", meaning: "避免；克制", pos: "v.", example: "The training manual explains when employees should refrain.", exampleZh: "訓練手冊說明員工應在何時避免。", level: "進階" },
  { word: "scrutinize", meaning: "仔細審查", pos: "v.", example: "The manager will scrutinize the request before Friday's deadline.", exampleZh: "經理會在星期五截止前仔細審查這項申請。", level: "進階" },
  { word: "subordinate", meaning: "下屬的；次要的", pos: "adj./n.", example: "The committee described the revised proposal as subordinate.", exampleZh: "委員會認為修改後的提案是下屬的。", level: "進階" },
  { word: "substantial", meaning: "大量的；可觀的", pos: "adj.", example: "The committee described the revised proposal as substantial.", exampleZh: "委員會認為修改後的提案是大量的。", level: "進階" },
  { word: "unprecedented", meaning: "前所未有的", pos: "adj.", example: "The committee described the revised proposal as unprecedented.", exampleZh: "委員會認為修改後的提案是前所未有的。", level: "進階" },
  { word: "viable", meaning: "可行的；能生存的", pos: "adj.", example: "The committee described the revised proposal as viable.", exampleZh: "委員會認為修改後的提案是可行的。", level: "進階" },
  { word: "waive", meaning: "免除；放棄", pos: "v.", example: "The training manual explains when employees should waive.", exampleZh: "訓練手冊說明員工應在何時免除。", level: "進階" },
  ...PDF_WORDS,
];
